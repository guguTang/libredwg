...
#define CAST_DWG_OBJECT_TO_OBJECT_BYNAME(token, dxfname)                      \
  ...
  typedef struct _dwg_entity_VERTEX_3D dwg_ent_vertex_3d, dwg_ent_vertex_mesh,
  ...
  typedef struct _dwg_entity_3DSOLID dwg_ent_3dsolid, dwg_ent_region,
      dwg_ent_body;
  ...
  typedef struct _dwg_object_ACDBNAVISWORKSMODELDEF
      dwg_obj_acdbnavisworksmodeldef;
  ...
  // dwg_obj_assocgeomdependency; typedef struct
  // _dwg_object_ASSOCOSNAPPOINTREFACTIONPARAM
  // dwg_obj_assocosnappointrefactionparam; typedef struct
  // _dwg_object_ASSOCVERTEXACTIONPARAM         dwg_obj_assocvertexactionparam;
  ...
  // dwg_obj_leaderobjectcontextdata; typedef struct _dwg_object_LIGHTLIST
  // dwg_obj_lightlist; typedef struct _dwg_object_NPOCOLLECTION
  // dwg_obj_npocollection; typedef struct _dwg_object_POINTCLOUD
  // dwg_obj_pointcloud; typedef struct _dwg_object_RTEXT dwg_obj_rtext; typedef
  // struct _dwg_object_SECTIONVIEWSTYLE     dwg_obj_sectionviewstyle; typedef
  // struct _dwg_object_TABLESTYLE           dwg_obj_tablestyle; typedef struct
...
#define dwg_get_OBJECT_DECL(name, OBJECT)                                     \
  ...
  EXPORT void dwg_ent_viewport_set_ucs_per_viewport (
      dwg_ent_viewport *restrict vp, unsigned char viewport,
      int *restrict error) __nonnull ((3)) _deprecated_dynapi_setter;
  EXPORT unsigned char
  ...
  EXPORT void dwg_ent_viewport_set_snap_base (
      dwg_ent_viewport *restrict vp, const dwg_point_2d *restrict point,
      int *restrict error) __nonnull ((2, 3)) _deprecated_dynapi_setter;
  ...
  EXPORT void dwg_ent_viewport_set_ucs_ortho_view_type (
      dwg_ent_viewport *restrict vp, const BITCODE_BS type,
      int *restrict error) __nonnull ((3)) _deprecated_dynapi_setter;
  ...
  EXPORT void dwg_ent_3dface_get_corner1 (
      const dwg_ent_3dface *restrict _3dface, dwg_point_2d *restrict point,
      int *restrict error) __nonnull ((2, 3)) _deprecated_dynapi_getter;
